    ...
    <div class="container-fluid mt-4" >
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a data-toggle="modal" data-target="#exampleModal" class="btn btn-neutral" style="background-color: #4cb04f !important; border: #4cb04f !important; color: white !important;">{{ __('New') }}</a>
            </div>
        </div>
        <!-- Table -->
        <div class="row">
